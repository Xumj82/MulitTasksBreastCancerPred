...
from .loading import (LoadAnnotations, LoadImageFromFile,LoadMMImageFromFile, LoadImageFromWebcam,
...
__all__ = [
    ...
    'LoadImageFromFile','LoadMMImageFromFile', 'LoadImageFromWebcam', 'LoadPanopticAnnotations',
