...
def main():
    ...
    if args.data_name == 'ddsm':
        ...
        generate_img_mask_pairs(DdsmSet(args.data_root,train=False),args.output_dir,train=False)
...
def generate_img_mask_pairs(data_set,dataset_name,train = True, verbose=True):
